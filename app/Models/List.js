...
export class List {
    constructor(listData) {
        ...
        this.numberOfTasksCompleted = listData.numberOfTasksCompleted || 0
        this.totalNumberTasks = listData.totalNumberTasks || 0
    }
    ...
    <div class="col-md-3">
        <div class="card my-2">
            <div class="card-header text-white color rounded shadow" style="background-color: ${this.color}">
                <div>
                    <h3>${this.listName}</h3> 
                    <div>
            ...
            <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                        ...
                        <h5> Tasks complete: ${this.numberOfTasksCompleted} / ${this.totalNumberTasks}</h5>
                    </div>
                </div>
            </div>
            <div card="card-body">
