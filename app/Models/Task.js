...
export class Task {
    constructor(taskData) {
        ...
        this.taskDone = taskData.taskDone || true
    }
    ...
    get CardTemplate() {
        ...
        <ul>
            ...
            <input type="checkbox" name="taskDone" id="taskDone" onclick="app.tasksController.taskDone('${this.id}')" ${this.taskDone == false ? "checked = 'checked'" : ""}>
